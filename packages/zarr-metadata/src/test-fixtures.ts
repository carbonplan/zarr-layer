...
/** GOES-R ABI geostationary projection (GOES-East / G16/G19) */
export const cfGeostationary: CFGridMappingAttributes = {
...
/** Polar stereographic (Antarctic, e.g. NSIDC) */
export const cfPolarStereographic: CFGridMappingAttributes = {
...
/** Mercator (standard parallel variant) */
export const cfMercator: CFGridMappingAttributes = {
...
export const cfAlbers: CFGridMappingAttributes = {
...
export const cfLaea: CFGridMappingAttributes = {
